...
class GCNNet(nn.Module):
    def __init__(self, net_params):
        ...
        # self.edge_mask1_train = nn.Parameter(torch.zeros(self.edge_num, 1), requires_grad=True)
        # self.edge_mask2_fixed = nn.Parameter(torch.zeros(self.edge_num, 1), requires_grad=False)


    def forward(self, g, h, e):

        g.edata['mask'] = self.edge_mask1_train * self.edge_mask2_fixed
