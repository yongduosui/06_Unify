...
from models import GIC, LogReg, GIC_GCN
...
def main(args):
    ...
    model = GIC_GCN(nb_nodes, ft_size, hid_units, nonlinearity, num_clusters, 100)
    # model = GIC(nb_nodes, ft_size, hid_units, nonlinearity, num_clusters, 100)
