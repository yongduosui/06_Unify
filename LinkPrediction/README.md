...
python -u main_gingat_rp.py --net gin --dataset cora --fix_epoch 200

python -u main_gingat_rp.py --net gin --dataset citeseer --fix_epoch 200

python -u main_gingat_rp.py --net gin --dataset pubmed --fix_epoch 200
...
python -u main_gingat_rp.py --net gat --dataset cora --fix_epoch 200

python -u main_gingat_rp.py --net gat --dataset citeseer --fix_epoch 200

python -u main_gingat_rp.py --net gat --dataset pubmed --fix_epoch 200
