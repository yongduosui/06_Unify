...
def main():
    ...
    for epoch in range(1, 1 + args.epochs):
        ...
        loss = train.train(model, predictor, emb.weight, adj_t, split_edge, optimizer, args.batch_size)
        results = train.test(model, predictor, emb.weight, adj_t, split_edge, evaluator, args.batch_size)
